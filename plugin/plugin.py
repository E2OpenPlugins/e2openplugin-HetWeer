	...
	def lijst(self):
		if self.iweertext == 'Neerslag Radars':
			...
			self.options.append((_("Maximum temperatuur"),"http://www.buienradar.nl/image/?type=weathermap-large&fn=temperatuurmax.000001.png&extension=png",'knmi maximum temperatuur kaart. \n\nKaart is stilstaand.'))
                        ...
                        self.options.append((_("Maximum Wind"),"http://www.buienradar.nl/image/?type=weathermap-large&fn=windmax.000001.png&extension=png",'Knmi maximum wnd \n\nKaart is stilstaand.'))
			self.options.append((_("Windsnelheid"),"http://www.buienradar.nl/weatherstation/gaugeimage?stationCode=6260&type=windspeed",'Windsnelheid in De Bilt. \n\nKaart is stilstaand.'))
			...
			self.options.append((_("Vandaag de hoogste temperatuur"),"http://www.onweer-online.nl/images/maps/tempwunderground.gif",'Acuele hoogste temperatuur kaart. \n\nKaart is stilstaand.'))
			self.options.append((_("Zeetemperatuur"),"http://www.onweer-online.nl/images/maps/zeetempknmi.png",'Temperatuur van het zeewater. \n\nKaart is stilstaand.'))
			...
			self.options = []
		        ...
		        self.options.append((_("Waarschuwingen in Nederland Overmorgen"),"http://www.onweer-online.nl/images/maps/knmi_overmorgen.png",'Waarschuwingen in Nederland. \n\nKaart is stilstaand.'))
                        self.options.append((_("Estofex storm west Europa"),"http://www.onweer-online.nl/images/maps/estofex.png",'Storm in West Europa. \n\nKaart is stilstaand.'))
                        self["list"].setList(self.options)
