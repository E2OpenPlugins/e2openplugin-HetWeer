        ...
        if sz_w > 1800:
            for day in range(0, 7):
                ...
                dayinfoblok += """
                    ...
                    <widget name="bigDirIcon1""" + str(day) + """" position="1170,355" size="42,42" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/HetWeer/Images/windhd/""" + str(windkracht) + """.png" zPosition="1" alphatest="on"/>
