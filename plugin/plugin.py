	...
	def lijst(self):
		if self.iweertext == 'Neerslag Radars':
			...
			self.options.append((_("Maximum temperatuur"),"http://www.buienradar.nl/image/?type=weathermap-large&fn=temperatuurmax.000001.png&extension=png",'knmi maximum temperatuur kaart. \n\nKaart is stilstaand.'))
                        ...
                        self.options.append((_("Minimum Grondtemperatuur"),"http://www.buienradar.nl/image/?type=weathermap-large&fn=temperatuurgrondmin.000001.png&extension=png",'Knmi minimum Grondtemperatuur kaart. \n\nKaart is stilstaand.'))
			...
			self.options.append((_("Zonuren in Nederland"),"http://www.buienradar.nl/image/?type=weathermap-large&fn=zonneschijn.000001.png&extension=png",'Knmi aantal zonuren in Nederland. \n\nKaart is stilstaand.'))
                        ...
                        self.options.append((_("Weerbeeld Australie"),"http://www.dwd.de/DE/wetter/wetter_weltweit/australien/bildgalerie/wetter_aktuell.jpg;jsessionid=A98F64BECA23290E8200AE88C3E15BA2.live11042?view=nasImage&nn=453812",'Weerbeeld voor Australie.'))
                        self.options.append((_("Weerbeeld Caribisch gebied"),"http://www.dwd.de/DE/wetter/wetter_weltweit/mittelamerika/bildgalerie/wetter_aktuell.jpg;jsessionid=A98F64BECA23290E8200AE88C3E15BA2.live11042?view=nasImage&nn=453780",'Weerbeeld Caribisch gebied.'))
                        self.options.append((_("Weerbeeld Amerika"),"http://www.dwd.de/DE/wetter/wetter_weltweit/nordamerika/bildgalerie/wetter_aktuell.jpg;jsessionid=0417C28E7D5D7B7424F428EFF4C43359.live21073?view=nasImage&nn=453764/",'Actuele weerbeeld in Amerika.'))
                        self.options.append((_("Weerbeeld Zuidoost Azie vandaag"),"http://www.dwd.de/DE/wetter/wetter_weltweit/suedostasien/bildgalerie/wetter_aktuell.jpg;jsessionid=1A30B979B88EE98B8D8312FD3CF963A5.live21061?view=nasImage&nn=453748",'Actuele weerbeeld in Zuidoost Azie.'))
                        self.options.append((_("Weerplaza Temperatuur NL"),"http://www.onweer-online.nl/images/maps/weerplaza_temperatuu.png",'Temperatuur kaart van weerplaza. \n\nKaart is stilstaand.'))
			...
			#waarschuwing
			self.options = []
                        self.options.append((_("Pollenradar Nederland"),"http://api.buienradar.nl/image/external/1.0/pollennl?v=1",'Kaart voor hoeveelheid Pollen in Nederland .'))
		        ...
		        self.options.append((_("Waarschuwingen in Drente"),"http://alarm.noodweercentrale.nl/images/map/drenthe_index.png",'Waarschuwingen in Drente. \n\nKaart is stilstaand.'))
		        self.options.append((_("Waarschuwingen in Overijsel"),"http://alarm.noodweercentrale.nl/images/map/overijssel_index.png",'Waarschuwingen in Overijsel. \n\nKaart is stilstaand.'))
		        self.options.append((_("Waarschuwingen in Gelderland"),"http://alarm.noodweercentrale.nl/images/map/gelderland_index.png",'Waarschuwingen in Gelderland. \n\nKaart is stilstaand.'))
		        self.options.append((_("Waarschuwingen in Flevoland"),"http://alarm.noodweercentrale.nl/images/map/flevoland_index.png",'Waarschuwingen in Flevoland. \n\nKaart is stilstaand.'))
		        self.options.append((_("Waarschuwingen in Utrecht"),"http://alarm.noodweercentrale.nl/images/map/utrecht_index.png",'Waarschuwingen in Utrecht. \n\nKaart is stilstaand.'))
		        self.options.append((_("Waarschuwingen in N Holland"),"http://alarm.noodweercentrale.nl/images/map/noordholland_index.png",'Waarschuwingen in N Holland. \n\nKaart is stilstaand.'))
		        self.options.append((_("Waarschuwingen in Z Holland"),"http://alarm.noodweercentrale.nl/images/map/zuidholland_index.png",'Waarschuwingen in Z Holland. \n\nKaart is stilstaand.'))
			...
			self.options.append((_("Minimum Temperatuur"),"&ecmwftype=12200&ctype=3"))
