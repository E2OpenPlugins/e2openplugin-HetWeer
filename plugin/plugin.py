...
class secondmenu(Screen):
	...
	def lijst(self):
		if self.iweertext == 'Neerslag Radars':
			...
			self.options.append((_("Radar Europa"),"http://sat24.com/?ir=false&ra=true&li=true",'Live radar voor west Europa, voor als je op de fiets naar Frankrijk wil.'))
			self.options.append((_("3 Dagen vooruit Eu"),"http://europa.buienradar.nl/3daagse.aspx",'3 dagen vooruit kijken in Europa.'))
			...
			self.options.append((_("Station Zoetermeer"),"http://www.onweer-online.nl/images/maps/weerzoetermeer.png",'Onweer kaart van weerstation Zoetermeer \n\nKaart is stilstaand.'))
