...
class secondmenu(Screen):
	...
	def lijst(self):
		if self.iweertext == 'Neerslag Radars':
			...
			self.options.append((_("Zeetemperatuur"),"http://www.onweer-online.nl/images/maps/zeewater_temperatuur.gif",'Temperatuur van het zeewater. \n\nKaart is stilstaand.'))
			self.options.append((_("Zeetemperatuur Europa"),"http://www.buienradar.nl/image/seatemperature?region=eu",'Europa is niet altijd onbewolkt,dan worden er 28 metingen per week verricht.. \n\nKaart is stilstaand.'))
